...
return array(
    ...
    'components'=>array(
        ...
        'db'=>array(
            'class'=>'CDbConnection',
            'connectionString' => 'mysql:host=dbm.fengchaotx.me;port=3308;dbname=dc_self_report',
            'emulatePrepare' => true,
            'username' => 'dsrwriter',
            'password' => 'fNuJcaQu39U4H9w5',
            'charset' => 'utf8',
        ...
        'user'=>array(
            'class'=>'CWebUser',
            'identityCookie'=>array('domain' => 'report.fengchaotx.com','path' => '/', 'httponly' => true), //配置用户cookie作用域
            //'allowAutoLogin'=>true,
            'stateKeyPrefix'=>'_refc_', //你的前缀,cookie的加密KEY,必须指定为一样的
//            'loginUrl'=>'https://data.wowotuan.com/login?return=selfreport',//array('site/login'),
            'loginUrl' => 'report.fengchaotx.com/login',
        ),
        ...
        'session'=>array(
            ...
            'cookieParams' => array('domain' => 'report.fengchaotx.com', 'lifetime' => '3600', 'httponly' => true), //配置会话ID作用域 生命期和超时
            'sessionName' => '_do_',//配置cookie的前缀
