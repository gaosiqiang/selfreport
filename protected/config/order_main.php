...
return array(
    ...
    'components'=>array(
        ...
        'db'=>array(
            'class'=>'CDbConnection',
            'connectionString' => 'mysql:host=10.8.210.177;port=3307;dbname=dc_self_report',
            'emulatePrepare' => true,
            'username' => 'root',
            'password' => '401401401401',
            'charset' => 'utf8',
        ...
        'user'=>array(
            'class'=>'CWebUser',
            'identityCookie'=>array('domain' => 'report.com','path' => '/', 'httponly' => true), //配置用户cookie作用域
            //'allowAutoLogin'=>true,
            'stateKeyPrefix'=>'_do_', //你的前缀,cookie的加密KEY,必须指定为一样的
//            'loginUrl'=>'https://data.wowotuan.com/login?return=selfreport',//array('site/login'),
            'loginUrl' => 'http://report.com/login',
        ),
        ...
        'session'=>array(
            ...
            //'cacheID' => 'rediscache',
            'class' => 'ARedisSession',
            'keyPrefix' => '_do_session:',
            'cookieParams' => array('domain' => 'report.com', 'lifetime' => '3600', 'httponly' => true), //配置会话ID作用域 生命期和超时
