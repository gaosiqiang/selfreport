    ...
    <fieldset>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php echo $form->passwordField($model,'password',array('class'=>'form-control','placeholder'=>'密码(必填)')); ?>
                </div>
                <div class="col-sm-3">
...
<!--            </div>-->
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <?php echo CHtml::listBox('area','',$area_arr,array('style'=>'width:163px;height:100px;','multiple'=>'multiple')); ?>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                    <?php echo CHtml::listBox('region','',$region_arr,array('style'=>'width:163px;height:150px;','multiple'=>'multiple')); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div id='select-cities' class="alert alert-warning" style="margin-bottom:10px;">
                        <label><input type="checkbox" id="allcity" name="allcity" value="allcity" <?php if(!empty($_POST['allcity'])) echo 'checked="checked"'; ?>> 勾选全部</label>
                        <!-- <label><input type="checkbox" id="quanguo" name="quanguo" value="quanguo" <?php //if(!empty($_POST['quanguo'])) echo "checked"; ?>> 全国</label><br> -->
                        <label><input type="checkbox" id="allsite" name="allsite" value="allsite" <?php if(!empty($_POST['allsite'])) echo 'checked="checked"'; ?>> 整站数据</label>
                        ...
                        <div>
                            ...
                            <input type="hidden" name="selected-ids" id="selected-ids" value=""/>
                        </div>
                        <div id="selected-city" style="margin-top:10px;"></div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="alert alert-warning" style="margin-bottom:0">
                        <?php echo CHtml::checkBoxList('priv_wdt_only', '', $cities_wdt_only, array('checkAll'=>'全选','separator'=>'&nbsp;&nbsp;'));?>
                    </div>
                </div>
            </div>
        </div>
